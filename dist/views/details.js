...
export default function DetailsOfMovie() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        setTimeout(() => {
            ...
            const loaderChild = document.querySelectorAll("#loader-child");
            console.log(loader);
    ...
    <div class="description">
      <div>
        <div id="img-loader" class="animated-background">
          <img id="details-img" style="display: none" class="details-movie-img"  src="https://image.tmdb.org/t/p/w500/${data.poster_path}"/>
        </div>
        <div>
          <div>
            <p>Release Date :</p>
            <div id="loader" class="animated-background" style="height: 10px; width: 100%">
            <span id="loader-child" style="display: none" class="type">${data.release_date}</span>
            </div>
          </div>
          <div>
            <p>Status :</p>
            <div id="loader" class="animated-background" style="height: 10px; width: 100%">
            <span id="loader-child" style="display: none" class="status">${data.status}</span>
            </div>
          </div>
          <div>
            <p>Studios :</p>
